...
def main():
    ...
    """
    text_name = sys.argv[1]  # input("Pfad des einzulesenden Textes: ")
...
def replace_ner(data):
    """
    Die Funktion replace_ner(X) liest eine getaggte Datei ein,
    ...
    for i in words:
        if "Reset" not in words[count]:
            neuer_text.append(words[count])
            neuer_text.append(' ')
        count += 1
    text = ''.join(neuer_text)
...
praelist_irgendwo = [
    ...
    "zuseiten", "In", "Um", "Ums", "Ab", "Bei", "Beim", "Gegenüber", "Nächst",
    "Nahe", "Vis-à-vis", "Abseits", "Außer", "Außerhalb", "Ausgangs",
    "Beidseits", "Beiderseits", "Diesseits", "Eingangs", "Entlang", "Fern",
    "Fernab", "Inmitten", "Innerhalb", "Jenseits", "Längs", "Längsseits",
    "Links", "Nördlich", "Nordöstlich", "Nordwestlich", "Oberhalb", "Östlich",
    "Rechts", "Seitlich", "Seitwärts", "Südlich", "Südöstlich", "Südwestlich",
    "Unfern", "Unterhalb", "Unweit", "Vis-à-vis", "Westlich", "Weitab",
    "Zunächst", "Zuseiten"
]
praelist_irgendwohin = [
    "nach", "zu", "zum", "zur", "bis", "durch", "entlang", "gegen", "gen",
    "lang", "Nach", "Zu", "Zum", "Zur", "Bis", "Durch",
    "Entlang", "Gegen", "Gen", "Lang"
]
praelist_irgendwoher = ["aus", "von", "vom", "Aus", "Von", "Vom"]
praelist_wechsel = [
    "am", "Am", "an", "An", "auf", "Auf", "hinter", "Hinter", "in", "In",
    "neben", "Neben", "Über", "über", "unter", "Unter", "Vor",
    "vor", "zwischen", "Zwischen", "im", "Im"
]

praelist_irgendeine = [
    "um", "Um", "ums", "Ums", "Ab", "ab", "bei", "beim",
    "Bei", "Beim", "Gegenüber", "gegenüber", "Nächst", "nächst", "nahe",
    "Nahe", "vis-à-vis", "Vis-à-vis", "Abseits", "abseits", "außer",
    "Außer", "Außerhalb", "außerhalb", "Ausgangs", "ausgangs",
    "Beidseits", "beidseits", "Beiderseits", "beiderseits", "diesseits",
    "Diesseits", "eingangs", "Eingangs", "Entlang",
    "entlang", "Fern", "fern", "Fernab", "fernab", "Inmitten", "inmitten",
    "Innerhalb", "innerhalb", "Jenseits", "jenseits", "Längs", "längs",
    "Längsseits", "längsseits", "Links", "links", "Nördlich", "nördlich",
    "Nordöstlich", "nordöstlich", "nordwestlich", "Nordwestlich", "oberhalb",
    "Oberhalb", "östlich", "Östlich", "Rechts", "rechts", "Seitlich",
    "seitlich", "seitwärts", "Seitwärts", "Südlich", "südlich", "Südöstlich",
    "südöstlich", "südwestlich", "Südwestlich", "unfern", "Unfern",
    "unterhalb", "Unterhalb", "unweit", "Unweit", "Westlich", "westlich",
    "weitab", "Weitab", "Zunächst", "zunächst", "zuseiten", "Zuseiten"
]
praelist_irgendeiner = [
    "aus", "von", "vom", "nach", "zu", "zum", "zur", "bis",
    "durch", "entlang", "gegen", "gen", "lang", "Aus", "Von",
    "Vom", "Nach", "Zu", "Zum", "Zur", "Bis", "Durch",
    "Entlang", "Gegen", "Gen", "Lang"
]
...
# Artikelliste:
artikel = [
    "der", "Der", "die", "Die", "das", "Das", "ein", "Ein",
    "Eine", "eine", "des", "Des", "Dem", "dem", "den", "Den", "Eines",
    "eines", "einer", "Einer", "einem", "Einem"
]
